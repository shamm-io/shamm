    ...
    return (
        <div className="container pb-8 max-w-5xl mx-auto border-t-2 border-t-white">
            ...
            <div className="flex px-16 justify-center mx-auto gap-x-2 items-center">
                ...
                <a className="basis-1/4 text-center bg-black rounded-lg py-2" href="#" role="button">Stay in the loop</a>
            </div>

            <div className="flex mt-5 mb-6 max-w-[65%] mx-auto">
                <Link href="/propose" className="hover:font-semibold hover:text-white transition-all w-full text-center">
                    Contact us
                </Link>
                <Link href="/propose" className="hover:font-semibold hover:text-white transition-all w-full text-center">
                    Privacy policy
            ...
            <p className="text-center font-bold">© 2023 Shamm. All rights reserved.</p>
        </div>
    );
}